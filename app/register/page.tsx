  ...
  return (
    <div className="flex-center" style={{ minHeight: '100vh', padding: '24px' }}>
      <div className="glass-panel" style={{ width: '100%', maxWidth: '400px' }}>
        <h1 className="heading-lg" style={{ textAlign: 'center' }}>Create Account</h1>
        <p className="text-muted" style={{ textAlign: 'center', marginBottom: '24px' }}>Join the Group Food Manager</p>
        ...
        <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            ...
            <input type="text" className="input-field" value={contact} onChange={e => setContact(e.target.value)} />
          </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '24px', fontSize: '0.9rem' }}>
          ...
          <Link href="/login" className="text-accent" style={{ textDecoration: 'none', fontWeight: '500' }}>Sign In</Link>
        </p>
      </div>
    </div>
  );
